...
function Editadminform({ hide, aid }) {
  ...
  const updateAdmin = (e) => {
    ...
    AdminService.updateadmin(aid, admin)
      .then((success) => {
  ...
  return (
    <div class="card m-5" style={{ background: "white", opacity: 1 }}>
